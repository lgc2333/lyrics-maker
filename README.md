...
Lyrics Maker（暂定名）是一款专注于歌词时间轴制作的 Web 工具。导入音频、粘贴歌词，在波形或频谱时间线上完成逐句、逐词的打轴与编辑，最后导出为标准歌词/字幕格式。
